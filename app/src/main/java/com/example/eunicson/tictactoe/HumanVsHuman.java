...
public class HumanVsHuman extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_human_3x3);

        //Text views for holding the points
        textViewPlayer1 = findViewById(R.id.hh3x3_p1);

        textViewDraw = findViewById(R.id.hh3x3_draw);

        textViewPlayer2 = findViewById(R.id.hh3x3_p2);
