...
public class HumanVsComputer extends AppCompatActivity {
    ...
    //TextView holding the second player's points
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_computer_3x3);

        //Text views for holding the points
        textViewPlayer1 = findViewById(R.id.hc3x3_p1);


        textViewDraw = findViewById(R.id.hc3x3_draw);

        textViewPlayer2 = findViewById(R.id.hc3x3_p2);
    ...
    public void playGame(View v) {
        ...
        if (comon.checkForWin3x3(buttons)) {
            return;
        } else {
            if (humanTurn) {
                ((Button) v).setText("X");
            ...
            if (comon.checkForWin3x3(buttons)) {
                ...
                if (comon.boardIsFull3x3(buttons)) {
    ...
    public void resetGame(View v) {
        comon.resetBoard(9, buttons);

        humanTurn = !humanTurn; //switch player to make the first move
    ...
    private void computerTurn() {
        if (comon.boardIsFull3x3(buttons)) {
            ...
            if (buttons[r].getText().toString().equals("")) {
                ...
                computerTurn();//recursive call to ensure the computer makes a move
            }
        }
    }
